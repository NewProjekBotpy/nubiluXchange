...
import { MobileBottomNav, LiveInsightsDashboard } from "@/components/admin";
import { useAuth } from "@/contexts/AuthContext";

function LiveInsightsContent() {
    ...
    <div className="min-h-screen bg-nxe-dark pb-20">
      <div className="sticky top-0 z-40 bg-nxe-dark/95 backdrop-blur-sm border-b border-nxe-border">
        <div className="container mx-auto px-2 sm:px-3 py-1.5 sm:py-2 flex items-center gap-1.5 sm:gap-2">
          ...
          <div>
            <h1 className="text-sm sm:text-lg font-bold text-white">Live Insights</h1>
            <p className="text-[10px] sm:text-xs text-gray-400">Real-time monitoring</p>
          </div>
        </div>
      </div>
      ...
      <MobileBottomNav activeTab="live-insights" onTabChange={() => {}} />
    </div>
  );
}
